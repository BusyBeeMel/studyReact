...
// Styles
import stylesMarket from '../../Styles/Components/Market.css';
    ...
    render() {
        ...
        return(
            <div>
                ...
                <div className={stylesMarket.popupTopContainer}>
                    <div className={styles.popupTopText}>
                        상품유형 <span className={styles.popupTopSubText}>{item.optionInfo[0].title}</span>
                    </div>
                    <div className={styles.popupTopText}>
